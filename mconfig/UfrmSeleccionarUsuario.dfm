object frmSeleccionarUsuario: TfrmSeleccionarUsuario
  Left = 297
  Top = 198
  Width = 696
  Height = 480
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
      'SELECT SU.ID, SU.USUARIO, S.NOMBRE'
      'FROM SUJETOS_USUARIOS SU, SUJETOS S'
      'WHERE (SU.SUJETO = S.ID) AND (SU.ID > 0)')
    Left = 208
    Top = 128
    ...
    object qyBusquedaUSUARIO: TIBStringField
      FieldName = 'USUARIO'

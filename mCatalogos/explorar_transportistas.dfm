inherited frmExplorar_transportistas: TfrmExplorar_transportistas
  Left = 214
  Top = 206
  Caption = 'Explorar Transportistas'
  ClientHeight = 362
  ClientWidth = 619
  ExplicitWidth = 320
  ExplicitHeight = 240
  ...
  inherited qyExplorar: TIBQuery
    SQL.Strings = (
        ...
        'SELECT ST.ID R_ID, S.CLAVE R_CLAVE, S.NOMBRE R_NOMBRE, S.FECHA_A' +
        'LTA R_FECHA_ALTA'
      
        'FROM SUJETOS_TRANSPORTISTAS ST LEFT JOIN SUJETOS S ON ST.SUJETO ' +
        '= S.ID'
      'WHERE ID = 0')

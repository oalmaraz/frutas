object frmSeleccionarConceptosGastos: TfrmSeleccionarConceptosGastos
  Left = 279
  Top = 249
  Caption = 'Seleccionar Conceptos Gastos'
  ClientHeight = 441
  ClientWidth = 680
  Color = clBtnFace
  ...
  object qyBusqueda: TIBQuery
    ...
    object qyBusquedaCONCEPTO: TIBStringField
      FieldName = 'CONCEPTO'
      Size = 100
    end
    object qyBusquedaPORC: TFloatField
      FieldName = 'PORC'
      DisplayFormat = '##0.00 %'
    end
  end
  object pmCampos: TPopupMenu
    ...
    object itemCONCEPTO: TMenuItem
      Caption = 'CONCEPTO'
      OnClick = itemCONCEPTOClick
    end
    object itemPORC: TMenuItem
      Caption = 'PORCENTAJE'
      OnClick = itemPORCClick
    end
  end
  object spAddPedimento: TIBStoredProc
    Database = IBDatabase1
    Transaction = IBTransaction1
    StoredProcName = 'ADD_PI_GASTOS'
    Left = 208
    Top = 192
    ParamData = <
      item
  ...
  object spADD_SERVICIO: TIBStoredProc
    Database = IBDatabase1
    Transaction = IBTransaction1
    StoredProcName = 'ADD_SERVICIO'
    Left = 240
    Top = 192
    ParamData = <
      item
  ...
  object spADD_PP_EXTRA: TIBStoredProc
    Database = IBDatabase1
    Transaction = IBTransaction1
    StoredProcName = 'ADD_PP_EXTRA'
    Left = 272
    Top = 192
    ParamData = <
      item
  ...
  object spA_TE_TARIFA: TIBStoredProc
    Database = IBDatabase1
    Transaction = IBTransaction1
    StoredProcName = 'A_TE_TARIFA'
    Left = 304
    Top = 192
    ParamData = <
      item

object frmSeleccionarCDescuento: TfrmSeleccionarCDescuento
  Left = 359
  Top = 185
  Caption = 'Seleccionar Conceptos de Descuento'
  ClientHeight = 441
  ClientWidth = 680
  Color = clBtnFace
  ...
  object qyBusqueda: TIBQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'SELECT D.ID, D.CLAVE, D.DESCRIPCION, D.DESCUENTO_PORC'
      'FROM CONCEPTOS_DESCUENTOS_NC D')
    Left = 208
    Top = 128

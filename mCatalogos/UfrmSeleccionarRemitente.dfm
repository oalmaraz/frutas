object frmSeleccionarRemitente: TfrmSeleccionarRemitente
  Left = 324
  Top = 212
  Caption = 'Seleccionar Remitente'
  ClientHeight = 0
  ClientWidth = 124
  Color = clBtnFace
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
      ...
      '       D.NUM_INT,'
      '       D.COLONIA,'
      '       EG.DESCRIPCION CIUDAD,'
      '       E2.DESCRIPCION ESTADO,'
      '       E3.DESCRIPCION PAIS'
      
        'FROM (SUJETOS_REMITENTES SR LEFT JOIN SUJETOS S ON SR.SUJETO = S' +
        '.ID)'
      '     LEFT JOIN DOMICILIOS D ON S.DOMICILIO = D.ID'
      '     LEFT JOIN ENTIDAD_GEOGRAFICA EG ON D.CIUDAD = EG.ID'
      '     LEFT JOIN ENTIDAD_GEOGRAFICA E2 ON EG.LINK  = E2.ID'
      '     LEFT JOIN ENTIDAD_GEOGRAFICA E3 ON E2.LINK  = E3.ID')
    Left = 208
    Top = 128
    ...
    object qyBusquedaCALLE: TIBStringField
      FieldName = 'CALLE'
      Origin = 'DOMICILIOS.CALLE'
      Size = 100
    end
    object qyBusquedaNUM_EXT: TIBStringField
      FieldName = 'NUM_EXT'
      Origin = 'DOMICILIOS.NUM_EXT'
      Size = 10
    end
    object qyBusquedaLETRA: TIBStringField
      FieldName = 'LETRA'
      Origin = 'DOMICILIOS.LETRA'
      Size = 10
    end
    object qyBusquedaNUM_INT: TIBStringField
      FieldName = 'NUM_INT'
      Origin = 'DOMICILIOS.NUM_INT'
      Size = 10
    end
    object qyBusquedaCOLONIA: TIBStringField
      FieldName = 'COLONIA'
      Origin = 'DOMICILIOS.COLONIA'
      Size = 50
    end
    object qyBusquedaCIUDAD: TIBStringField
      FieldName = 'CIUDAD'
      Origin = 'ENTIDAD_GEOGRAFICA.DESCRIPCION'
      Size = 100
    end
    object qyBusquedaESTADO: TIBStringField
      FieldName = 'ESTADO'
      Origin = 'ENTIDAD_GEOGRAFICA.DESCRIPCION'
      Size = 100
    end
    object qyBusquedaPAIS: TIBStringField
      FieldName = 'PAIS'
      Origin = 'ENTIDAD_GEOGRAFICA.DESCRIPCION'
      Size = 100
    end
  ...
  object pmCampos: TPopupMenu
    ...
    object itemDIRECCION: TMenuItem
      Caption = 'DIRECCION'
      OnClick = itemDIRECCIONClick
    end
    object itemCIUDAD: TMenuItem
      Caption = 'CIUDAD'
      OnClick = itemCIUDADClick
    end
  end
end

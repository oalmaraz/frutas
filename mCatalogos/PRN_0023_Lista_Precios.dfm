inherited frmPRN_0023_Lista_Precios: TfrmPRN_0023_Lista_Precios
  Left = 179
  Top = 154
  ActiveControl = cbGrupoListaPrecios
  Caption = 'PRN_0023'
  ClientHeight = 66
  ClientWidth = 465
  OldCreateOrder = True
  ...
  inherited fpPadre: TPanel
    ...
    object Label1: TLabel [1]
      ...
      Width = 201
      Height = 13
      Caption = '&Grupo Lista de Precios (Alt + Flecha abajo)'
      FocusControl = cbGrupoListaPrecios
    end
    ...
    object cbGrupoListaPrecios: TDBLookupComboBox
      Left = 5
      Top = 40
      Width = 252
      Height = 21
      DataField = 'DESCRIPCION'
      DataSource = dsNombreListaPrecios
      TabOrder = 0
    end
    object deFecha: TDateTimePicker
      ...
      Date = 42116.549530544
      Time = 42116.549530544
      DateFormat = dfShort
      DateMode = dmComboBox
      Kind = dtkDate
      ParseInput = False
  ...
  object dsNombreListaPrecios: TDataSource
    DataSet = qyNombreListaPrecios
    Left = 48
    Top = 80
  end
  object qyListaPreciosPartidas: TIBQuery
    Database = dmIBModulo.ibSistema
    Transaction = dmIBModulo.ibSistemaTransaccion
    DataSource = dsNombreListaPrecios
    SQL.Strings = (
      'SELECT *'
      'FROM LISTA_PRECIOS_PARTIDAS_INCLUIR(:ID, :FECHA, '#39'Si'#39')')
    Left = 16
    Top = 112
    ParamData = <
      item
    ...
    object qyListaPreciosPartidasR_MATERIAL_CLAVE: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_MATERIAL_CLAVE'
      ReadOnly = True
    end
    object qyListaPreciosPartidasR_MATERIAL_DESCRIPCION: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_MATERIAL_DESCRIPCION'
      ReadOnly = True
      Size = 100
    end
    object qyListaPreciosPartidasR_MATERIAL_UNIDAD_DESC: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_MATERIAL_UNIDAD_DESC'
      ReadOnly = True
      Size = 50
    end
    object qyListaPreciosPartidasR_PRECIO_MINIMO: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'R_PRECIO_MINIMO'
      ReadOnly = True
    end
    object qyListaPreciosPartidasR_PRECIO_MAXIMO: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'R_PRECIO_MAXIMO'
      ReadOnly = True
    end
  end
  object qyNombreListaPrecios: TIBQuery
    Database = dmIBModulo.ibSistema
    Transaction = dmIBModulo.ibSistemaTransaccion
    AfterOpen = qyNombreListaPreciosAfterOpen
    OnCalcFields = qyNombreListaPreciosCalcFields
    SQL.Strings = (
      'SELECT *'
      'FROM NOMBRE_LISTA_PRECIOS'
      'ORDER BY ID')
    Left = 16
    Top = 80
    object qyNombreListaPreciosID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object qyNombreListaPreciosDESCRIPCION: TIBStringField
      FieldName = 'DESCRIPCION'
      Size = 100
    end
    object qyNombreListaPreciosVIGENCIA_DIAS: TIntegerField
      FieldName = 'VIGENCIA_DIAS'
    end
    object qyNombreListaPreciosfecha: TDateField
      FieldKind = fkCalculated
      FieldName = 'fecha'
      Calculated = True
    end
    object qyNombreListaPreciosfecha_actual: TDateField
      FieldKind = fkCalculated
      FieldName = 'fecha_actual'
      Calculated = True
    end
  end
  object dsListaPreciosPartidas: TDataSource
    DataSet = qyListaPreciosPartidas
    Left = 48
    Top = 112
  end
end

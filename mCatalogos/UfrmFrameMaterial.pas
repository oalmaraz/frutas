...
uses
  ...
  IBCustomDataSet, IBQuery, IBTable,
    IBStoredProc,  UfrmSeleccionarMaterialCompras,
      DBCtrls;
...
begin
   ...
   case tipo of
     obEntrada: begin
                   ...
                   edPU.Visible          := false;
                   {
                   edPrecioCosto.DisplayFormat := '$ ,0.0000;-$ ,0.0000';
                   }
                end;
     obSalida : begin
                   ...
                   edPU.Visible          := true;
                   {
                   edPrecioCosto.DisplayFormat := '$ ,0.00;-$ ,0.00';
                   }
                end;
   end;
end;
...
begin
   ...
   begin
      ...
      if FLAG_ESTADO = stNuevo then
         cbUnidades.LookupKeyValue := pUnidad;
      }
      if FLAG_MEDIDAS then
      begin
...
begin
   ...
   case AbsoluteIndex of
     0: begin
           ...
           qyExistencia.Open;
           edExistencia.Text := qyExistencia.FieldByName('R_ORIGINAL').AsString;
           edOtros.caption       := FormatFloat('###,###,##0.0000',qyExistencia.FieldByName('R_OTROS').AsFloat);
           ...
           begin
              ...
              begin
                 ...
                 edDescuentoPorc.text := qyPrecio_X.FieldByName('R_OFERTA_PORC').AsString;
              ...
              edPrecioCosto.text :=  FormatFloat('###,###,##0.0000', PRECIOMAXIMO);
...
begin
   ...
   begin
      ...
      begin
         case tipo of
            obSalida: begin
                          ...
                          qyCalculoImpuestos.ParamByName('P_CANTIDAD').AsFloat     := StrToFloat (edCantidad.Text);
                          qyCalculoImpuestos.ParamByName('P_PRECIO_VENTA').AsFloat := StrToFloat (edPrecioCosto.Text);
                          qyCalculoImpuestos.Open;

                          edSubTotal.Text  := qyCalculoImpuestos.FieldByName('R_SUBTOTAL').AsString;
                          edIVA.Text       := qyCalculoImpuestos.FieldByName('R_IVA').AsString;
                          edIEPS.Text      := qyCalculoImpuestos.FieldByName('R_IEPS').AsString;
                          edImpuesto1.Text := qyCalculoImpuestos.FieldByName('R_IMPUESTO1').AsString;
                          edImpuesto2.Text := qyCalculoImpuestos.FieldByName('R_IMPUESTO2').AsString;
                          edPU.Text        := qyCalculoImpuestos.FieldByName('R_PRECIO').AsString;
            ...
            obEntrada: begin
                          ...
                          qyCalculoImpuestosCosto.ParamByName('P_CANTIDAD').AsFloat     := StrToFloat(edCantidad.Text);
                          qyCalculoImpuestosCosto.ParamByName('P_COSTO').AsFloat        := StrToFloat(edPrecioCosto.Text);
                          qyCalculoImpuestosCosto.Open;

                          edSubTotal.Text  := qyCalculoImpuestosCosto.FieldByName('R_SUBTOTAL').AsString;
                          edIVA.Text       := qyCalculoImpuestosCosto.FieldByName('R_IVA').AsString;
                          edIEPS.Text      := qyCalculoImpuestosCosto.FieldByName('R_IEPS').AsString;
                          edImpuesto1.Text := qyCalculoImpuestosCosto.FieldByName('R_IMPUESTO1').AsString;
                          edImpuesto2.Text := qyCalculoImpuestosCosto.FieldByName('R_IMPUESTO2').AsString;
                          edPU.Text        := qyCalculoImpuestosCosto.FieldByName('R_COSTO').AsString;
      ...
      begin
         cant := StrToFloat(edCantidad.Text) ;
         precio := StrToFloat(edPrecioCosto.Text);
         subtotal := cant * precio;

         edSubTotal.Text  :=  FloatToStr(subtotal);
         edPU.Text        := edPrecioCosto.Text;

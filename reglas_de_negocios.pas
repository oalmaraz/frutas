...
uses
   USqlAnaliza,    IBDatabase, IBTable, IBQuery, graphics, windows, Menus, forms, db, controls, comctrls,
   classes, extctrls, dbgrids;
...
procedure forma(const objeto : string; fuente : TDBGrid); forward; overload;
...
procedure forma(const objeto : string; fuente : TDBGrid);
var
   i       : integer;
   iFound  : integer;
begin
...
begin
   ...
   begin
      ...
      'La configuración de la fecha es incorrecta, debe ser:'+#13+#13+'Windows Español = dd/mm/aaaa'+#13+'Windows Ingles = dd/mm/yyyy.',
      mtConfirmation, [mbYes, mbNo], 0) = mrYes  then
      begin

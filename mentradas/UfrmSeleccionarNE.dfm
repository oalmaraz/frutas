object frmSeleccionarNE: TfrmSeleccionarNE
  Left = 249
  Top = 198
  Width = 696
  Height = 480
  Caption = 'Seleccionar Nota de Entrada'
  Color = clBtnFace
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
      ...
      '       S.TEL_PRINCIPAL P_TELEFONO,'
      '       O.ID O_ID,'
      '       O.CONSECUTIVO O_FOLIO,'
      '       O.CLAVE O_CLAVE'
      
        'FROM NOTAS_DE_ENTRADA E, SUJETOS_PROVEEDORES SP, SUJETOS S, ORDE' +
        'NES_DE_COMPRAS O '
      
        'WHERE (E.PROVEEDOR = SP.ID) AND (SP.SUJETO = S.ID) AND (E.ESTATU' +
        'S = '#39'Sin Afectar'#39') AND (E.ORDEN_COMPRA = O.ID) AND (E.ORDEN_COMP' +
        'RA <> -3)'
      'AND (SP.ID = 0)')
    Left = 208
    Top = 128
    ...
    object qyBusquedaFACTURA_PROVEEDOR: TIBStringField
    ...
    object qyBusquedaP_CLAVE: TIBStringField
      FieldName = 'P_CLAVE'
      Origin = 'SUJETOS.CLAVE'
      Size = 50
    end
    object qyBusquedaP_NOMBRE: TIBStringField
      FieldName = 'P_NOMBRE'
      Origin = 'SUJETOS.NOMBRE'
      Size = 100
    end
    object qyBusquedaP_TELEFONO: TIBStringField
      FieldName = 'P_TELEFONO'
      Origin = 'SUJETOS.TEL_PRINCIPAL'
    end
    object qyBusquedaP_RAZON_SOCIAL: TIBStringField
      FieldName = 'P_RAZON_SOCIAL'
      Origin = 'SUJETOS.RAZON_SOCIAL'
      Size = 100
    end
    object qyBusquedaO_ID: TIntegerField
      FieldName = 'O_ID'
      Origin = 'ORDENES_DE_COMPRAS.ID'
      Required = True
    end
    object qyBusquedaO_FOLIO: TIntegerField
      FieldName = 'O_FOLIO'
      Origin = 'ORDENES_DE_COMPRAS.CONSECUTIVO'
    end
    object qyBusquedaO_CLAVE: TIBStringField
      FieldName = 'O_CLAVE'
  ...
  object pmCampos: TPopupMenu
    ...
    object itemFACTURA: TMenuItem
      Caption = 'PROVEEDOR-FACTURA'
      OnClick = itemFACTURAClick
    end
  ...
  object spADD_NE_A_NE: TIBStoredProc
    Database = IBDatabase1
    Transaction = IBTransaction1
    StoredProcName = 'ADD_NE_A_NE'
    Left = 208
    Top = 208
    ParamData = <
      item

object frmCXP_PagosD: TfrmCXP_PagosD
  Left = 350
  Top = 515
  Width = 672
  Height = 200
  Caption = 'Foma de Pago'
  Color = clBtnFace
  ...
  object qyDetalle: TIBQuery
    ...
    object qyDetalleR_ID: TIntegerField
      FieldName = 'R_ID'
      Origin = 'TL_CXP_PAGOS_DET.R_ID'
    end
    object qyDetalleR_CC: TIntegerField
      FieldName = 'R_CC'
      Origin = 'TL_CXP_PAGOS_DET.R_CC'
    end
    object qyDetalleR_CC_C: TIBStringField
      FieldName = 'R_CC_C'
      Origin = 'TL_CXP_PAGOS_DET.R_CC_C'
    end
    object qyDetalleR_CC_N: TIBStringField
      FieldName = 'R_CC_N'
      Origin = 'TL_CXP_PAGOS_DET.R_CC_N'
      Size = 100
    end
    object qyDetalleR_REFERENCIA: TIBStringField
      FieldName = 'R_REFERENCIA'
      Origin = 'TL_CXP_PAGOS_DET.R_REFERENCIA'
    end
    object qyDetalleR_FOLIO: TIntegerField
      FieldName = 'R_FOLIO'
      Origin = 'TL_CXP_PAGOS_DET.R_FOLIO'
    end
    object qyDetalleR_BANCO: TIntegerField
      FieldName = 'R_BANCO'
      Origin = 'TL_CXP_PAGOS_DET.R_BANCO'
    end
    object qyDetalleR_BANCO_C: TIBStringField
      FieldName = 'R_BANCO_C'
      Origin = 'TL_CXP_PAGOS_DET.R_BANCO_C'
      Size = 50
    end
    object qyDetalleR_BANCO_N: TIBStringField
      FieldName = 'R_BANCO_N'
      Origin = 'TL_CXP_PAGOS_DET.R_BANCO_N'
      Size = 100
    end
    object qyDetalleR_FECHA: TDateTimeField
      FieldName = 'R_FECHA'
      Origin = 'TL_CXP_PAGOS_DET.R_FECHA'
      DisplayFormat = 'dd/mm/yyyy'
    end
    object qyDetalleR_MONTO: TFloatField
      FieldName = 'R_MONTO'
      Origin = 'TL_CXP_PAGOS_DET.R_MONTO'
      DisplayFormat = '$ ###,###,##0.00'
    end
  end

object frmSeleccionarProveedor_: TfrmSeleccionarProveedor_
  Left = 211
  Top = 212
  Width = 696
  Height = 480
  ...
  object pmCampos: TPopupMenu
    ...
    object itemCompraMinima: TMenuItem
      Caption = 'COMPRA MINIMA'
      OnClick = itemCompraMinimaClick
    end
    object itemTELEFONO: TMenuItem
      Caption = 'TELEFONO'
      OnClick = itemTELEFONOClick
    end
  end
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT SP.ID, S.CLAVE, S.NOMBRE, S.RAZON_SOCIAL, SP.COMPRA_MINIM' +
        'A, S.FACTURAR_A, S.TEL_PRINCIPAL, SP.FORMAS_DE_PAGO, SP.DESCUENT' +
        'O_PORC, SP.MONEDA, SP.ESTATUS'
      'FROM SUJETOS_PROVEEDORES SP, SUJETOS S'
      'WHERE (SP.SUJETO = S.ID) '
      'AND (SP.ID = 0)')
    Left = 208
    Top = 128
    ...
    object qyBusquedaCOMPRA_MINIMA: TFloatField
      FieldName = 'COMPRA_MINIMA'
      DisplayFormat = '$ ###,###,##0.00'
    end
    object qyBusquedaFACTURAR_A: TIBStringField
      FieldName = 'FACTURAR_A'
      Size = 12
    end
    object qyBusquedaTEL_PRINCIPAL: TIBStringField
      FieldName = 'TEL_PRINCIPAL'
      Origin = 'SUJETOS.TEL_PRINCIPAL'
    end
    object qyBusquedaFORMAS_DE_PAGO: TIntegerField
      FieldName = 'FORMAS_DE_PAGO'
      Origin = 'SUJETOS_PROVEEDORES.FORMAS_DE_PAGO'
    end
    object qyBusquedaDESCUENTO_PORC: TFloatField
      FieldName = 'DESCUENTO_PORC'
      Origin = 'SUJETOS_PROVEEDORES.DESCUENTO_PORC'
    end
    object qyBusquedaMONEDA: TIntegerField
      FieldName = 'MONEDA'
      Origin = 'SUJETOS_PROVEEDORES.MONEDA'
    end

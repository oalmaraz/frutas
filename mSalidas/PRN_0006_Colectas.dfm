inherited frmPRN_0006: TfrmPRN_0006
  Left = 465
  Top = 239
  ...
  inherited fpPadre: TPanel
    ...
    object deFecha: TDateTimePicker
      ...
      Width = 91
      Height = 21
      Date = 42129.464430335600000000
      Time = 42129.464430335600000000
      TabOrder = 0
    end
  ...
  object qyColectas: TIBQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM PRN_0006(:P_FECHA, :P_CAJA, :P_ALMACEN)')
    Left = 136
    Top = 96
    ParamData = <
      item
    ...
    object qyColectasR_ID: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_ID'
      ReadOnly = True
    end
    object qyColectasR_FECHA: TDateTimeField
      FieldKind = fkInternalCalc
      FieldName = 'R_FECHA'
      ReadOnly = True
    end
    object qyColectasR_CAJA: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_CAJA'
      ReadOnly = True
    end
    object qyColectasR_CAJA_NOMBRE: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_CAJA_NOMBRE'
      ReadOnly = True
      Size = 100
    end
    object qyColectasR_ALMACEN: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_ALMACEN'
      ReadOnly = True
    end
    object qyColectasR_ALMACEN_NOMBRE: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_ALMACEN_NOMBRE'
      ReadOnly = True
      Size = 100
    end
    object qyColectasR_USUARIO: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_USUARIO'
      ReadOnly = True
    end
    object qyColectasR_USUARIO_NOMBRE: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_USUARIO_NOMBRE'
      ReadOnly = True
      Size = 100
    end
    object qyColectasR_REFERENCIA: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_REFERENCIA'
      ReadOnly = True
      Size = 50
    end
    object qyColectasR_TOTAL: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'R_TOTAL'
      ReadOnly = True
    end
    object qyColectasR_ID_DETALLE: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_ID_DETALLE'
      ReadOnly = True
    end
    object qyColectasR_REFERENCIA_PAGO: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_REFERENCIA_PAGO'
      ReadOnly = True
    end
    object qyColectasR_REFERENCIA_NOMBRE: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_REFERENCIA_NOMBRE'
      ReadOnly = True
      Size = 50
    end
    object qyColectasR_CANTIDAD: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_CANTIDAD'
      ReadOnly = True
    end
    object qyColectasR_MONTO: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'R_MONTO'
      ReadOnly = True
    end
    object qyColectasR_TOTAL_DETALLE: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'R_TOTAL_DETALLE'
      ReadOnly = True
    end
    object qyColectasR_REFERENCIA_DETALLE: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_REFERENCIA_DETALLE'
      ReadOnly = True
      Size = 50
    end
    object qyColectasR_BANCO: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_BANCO'
      ReadOnly = True
    end
    object qyColectasR_BANCO_NOMBRE: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_BANCO_NOMBRE'
      ReadOnly = True
      Size = 100
    end
    object qyColectasR_ESTATUS: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_ESTATUS'
      ReadOnly = True
    end
  end
  object dsColectas: TDataSource
    DataSet = qyColectas
    Left = 168
    Top = 96
  end

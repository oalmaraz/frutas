object frmInsuficienciasSurtimiento: TfrmInsuficienciasSurtimiento
  Left = 466
  Top = 103
  Width = 850
  Height = 460
  Caption = 'Insuficiencias'
  Color = clBtnFace
  ...
  object qyInsuficientes: TIBQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM TL_INSUFICIENTES_SURTIMIENTO(:P_ID, :P_ALMACEN)')
    Left = 192
    Top = 120
    ParamData = <
      item
  ...
  object dsInsuficientes: TDataSource
    DataSet = qyInsuficientes
    Left = 224
    Top = 120
  end
end

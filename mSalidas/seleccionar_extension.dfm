inherited frmSeleccionar_extension: TfrmSeleccionar_extension
  Left = 153
  Top = 149
  ...
  inherited qySeleccionar: TIBQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM VER_EXTENSIONES')
    object qySeleccionarR_ID_EXTENSION: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_ID_EXTENSION'
      ReadOnly = True
    end
    object qySeleccionarR_ID_CLIENTE: TIntegerField
      FieldKind = fkInternalCalc
    ...
    object qySeleccionarR_FOTO: TBlobField
      FieldKind = fkInternalCalc
      FieldName = 'R_FOTO'
      ReadOnly = True
      BlobType = ftBlob
    ...
    object qySeleccionarR_FIRMA: TBlobField
      FieldKind = fkInternalCalc
      FieldName = 'R_FIRMA'
      ReadOnly = True
      BlobType = ftBlob
    ...
    object qySeleccionarR_LIMITE_CREDITO: TFloatField
      FieldKind = fkInternalCalc

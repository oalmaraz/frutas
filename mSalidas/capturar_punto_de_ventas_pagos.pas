...
uses
  IBDatabase, Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  ExtCtrls, ComCtrls, Grids, DBGrids,  Db, Menus, IBStoredProc,
  IBCustomDataSet, IBQuery, DBCtrls, StdCtrls, Buttons, Mask;
...
begin
  ...
  begin
     ...
     begin
        try
           FuncPoint := GetProcAddress (HLibr, PChar (IdHuella)); //Cargamos la función
           ...
           begin
              ...
              ShowMessage ('No existe la función ' + IdHuella);
        finally
